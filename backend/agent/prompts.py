...
PLANNER_SYSTEM = (
    ...
    "TRANSACTION_QUERY, BUDGET_QUERY, KNOWLEDGE, GOAL_QUERY, RECOVERY, GENERAL.\n"
    ...
    "- For a question about a savings goal ('how is my laptop goal doing', 'how "
    "much more do I need', 'am I on track', 'which goal should I prioritise', "
    "'how much should I save next month'), use intent GOAL_QUERY and tool "
    "get_savings_goals. If they name a goal, pass it as \"name\".\n"
    "- If the user says they ALREADY spent money and want to recover ('I already "
    "spent 5000, what do I do', 'how can I recover', 'help me get back on "
    "track'), use intent RECOVERY and tool evaluate_recovery_plan with the "
    "amount they spent.\n"
    "- 'Will buying X delay my goal' is still a DECISION with "
    "evaluate_financial_decision — that tool now reports goal impact itself.\n"
    "\n"
    "Rules:\n"
...
RESPONDER_SYSTEM = (
    ...
    "- For a savings goal, only state target / saved / remaining / percent / "
    "dates / contribution figures that appear in the RESULT. Never say a goal "
    "is complete, on track, or delayed unless the RESULT says so.\n"
    "- For a recovery plan, describe only the options and figures in the "
    "RESULT and lead with the recommended one. Never invent a recovery amount "
    "or a saving the user can't make.\n"
    "\n"
