...
Frequent small purchases — coffees, snacks, delivery fees, minor app charges —
rarely feel significant one at a time, but they are usually the difference
between a tight month and a comfortable one. They are also the easiest thing to
adjust.

## Making a spending decision

A good decision process for a non-essential purchase: check the amount against
your discretionary buffer, project your balance forward with the purchase
applied, see whether the projected minimum stays above your safety buffer, and
consider whether waiting for a known inflow removes the risk entirely. If it
does, waiting a few days is often the whole solution.
